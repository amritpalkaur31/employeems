...
const addLeave = async (req, res) => {
    try{
            const {userId, leaveType, startDate, endDate, appliedDate, reason } = req.body
            const employee = await Employee.findOne({userId})
        
            const newLeave = new Leave({
               employeeId: employee._id, leaveType, startDate, endDate, appliedDate, reason
            }) 
...
const getLeaves = async (req, res) => {
    try {
      ...
      // Filter out leaves with null employeeId (invalid references)
